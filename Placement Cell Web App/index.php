...
<body>
    ...
    <div class="container d-flex flex-column justify-content-center align-items-center text-center position-relative" data-aos="zoom-out">
            <img src="assets/img/Asset1.png" class="img-fluid animated">
            <h2>Welcome to <span>Chandigarh University Placement Cell Website</span></h2>
            <p>A project for showcase by 8th sem students AIT CSE-Cloud Computing </p>
            <div class="d-flex">
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-8 col-md-6 content d-flex flex-column justify-content-center order-last order-md-first">
                        ...
                        <p>The Placement Cell plays a crucial role in locating job
                            ...
                            <br>This is a presentation project created by Aryendra Agnihoti, Anurag Tomar and Ankit Ahir in collaboration
                            to present for the evaluation of final 8th semester captstone project.
                        </p>
                    ...
                    <div class="tab-pane active show" id="tab-1">
                        <div class="row gy-4">
                            <div class="col-lg-8 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="100">
                                ...
                                <ul>
                                    <li><i class="bi bi-check-circle-fill"></i> To help student out with various placement regarding queries.
                                    </li>
                                    <li><i class="bi bi-check-circle-fill"></i> To create a platform for everyone.
                                    </li>
                                    <li><i class="bi bi-check-circle-fill"></i> To maintain a community that supports everyone requirements regarding placement.</li>
